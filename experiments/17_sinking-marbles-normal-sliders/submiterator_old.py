...
#write the bash script for approving results from MTurk
approveHIT = open(dict["nameofexperimentfiles"] + "-approveHIT.sh", 'w')
approveHIT.write("#!/usr/bin/env sh\npushd " + dict["locationofCLT"] + "/bin\n./approveWork.sh -successfile " + dict["hitfolderpath"] + "/" + dict["nameofexperimentfiles"])
approveHIT.close()
