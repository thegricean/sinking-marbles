function make_slides(f) {
  ...
  slides.cause_effect_prior = slide({
	...
	$("#eventdescription").val("");	
      ...
      var effect_question = "Do you think "+ stim.other_name + " is describing a normal event?";
      var abnormality_question = "If you said 'no', what do you think is not normal about it?";
      ...
      $("#abnormality_question").html(abnormality_question);
...
//      this.stim.actual_utterance = utterance;      
      ...
      $(".contbutton").click(function() {
		...
		if (ok_to_go_on) {
			...
			stim.response = $("input[name=radioresponse]:checked").val();
	    	stim.strangedescription = $("#eventdescription").val();         				
	        exp.data_trials.push({
    	      "trial_type" : "cause_effect_prior",
        	  "slide_number_in_experiment" : exp.phase,
	          "object": stim.object,
    	      "object_level": stim.object_level,
        	  "cause": stim.cause,
	          "num_objects": stim.N,
    	      "effect": stim.effect,
        	  "name": stim.name,
	          "gender" : stim.gender,
    	      "other_gender" : stim.other_gender,
        	  "actual_cause": stim.actual_cause,
	          "actual_effect_question": stim.actual_effect_question,
    	      "actual_utterance": stim.actual_utterance,          
        	  "quantifier" : stim.quantifier,
		      "response" : stim.response, //$("input[name=radioresponse]:checked").val(),//this.stim.response,
		      "strangedescription": stim.strangedescription,
    	      "rt" : Date.now() - stim.trial_start
			});    	      
          $(".err").hide();
