  ...
  slides.cause_effect_prior = slide({
    ...
    present_handle : function(stim) {
      ...
      if (stim.end_cause.length > 0) {
        var sentence = stim.name + " " + stim.beginning_cause + " 100 " + stim.object + " " + stim.end_cause + ".";
      } else {
        var sentence = stim.name + " " + stim.beginning_cause + " 100 " + stim.object + ".";
      }
    ...
    init_sliders : function() {
      utils.make_slider("#single_slider", function(event, ui) {
        exp.sliderPost = Math.round(ui.value * 100);
        $("#number_guess").html(Math.round(ui.value * 100));
      });
    },
