function make_slides(f) {
  ...
  slides.cause_effect_prior = slide({
    ...
    present_handle : function(stim) {
      ...
      this.init_sliders();
      exp.sliderPost = null;
      exp.unusual_sliderPost = null;      
      $("#number_guess").html("?");
      $("#unusual_number_guess").html("?");      
      this.stim = stim;
      console.log(stim.cause);
      if (stim.end_cause.length > 0) {
        var sentence = "Imagine: " + stim.name + " " + stim.beginning_cause + " 15 <strong>normal</strong> " + stim.object + " " + stim.end_cause + ". How many of them " + stim.effect + "?";
      } else {
        var sentence = "Imagine: " + stim.name + " " + stim.beginning_cause + " 15 <strong>normal</strong> " + stim.object + ". How many of them " + stim.effect + "?";
      }
...
//      this.stim.question = question;
      ...
      if (stim.end_cause.length > 0) {
        var unusual_sentence = "Imagine " + stim.name + " " + stim.beginning_cause + " 15 <strong>unusual</strong> " + stim.object + " " + stim.end_cause + ". How many of them " + stim.effect + "?";
      } else {
        var unusual_sentence = "Imagine: " + stim.name + " " + stim.beginning_cause + " 15 <strong>unusual</strong> " + stim.object + ". How many of them " + stim.effect + "?";
      }
      $("#unusual_sentence").html(unusual_sentence);
//      $("#unusual_question").html(unusual_question);
      this.stim.sentence = sentence;
//      this.stim.question = question;
    ...
    button : function() {
    	...
    	console.log(exp.unusual_sliderPost);    	
      if (exp.sliderPost != null) {
	      if (exp.unusual_sliderPost != null) {	      	
        	this.log_responses();
    ...
    init_sliders : function() {
      ...
      utils.make_slider("#unusual_slider", function(event, ui) {
        exp.unusual_sliderPost = Math.round(ui.value * 15);
        $("#unusual_number_guess").html(Math.round(ui.value * 15));
      });      
    },
    log_responses : function() {
      exp.data_trials.push({
        ...
        "response_unusual" : exp.unusual_sliderPost,        
