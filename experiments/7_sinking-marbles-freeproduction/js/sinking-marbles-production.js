...
//      var random_objnumber = getRandomInt(0, stim.N);
      var trial_objnumber = getRandomInt(0, stim.N + 1);
      var description = stim.other_name + " observed that "+ trial_objnumber + " of the " + stim.object + " " + stim.effect + " and said:";
      var prompt = "How do you think "+stim.other_name + " would describe this event in one sentence to a friend? Fill in the blank.";

//      var effect_question = "For each of the following words, adjust the slider to indicate how likely you think it is that "+stim.other_name+" used that word.";
      var utterance = '';
      		this.stim.actual_utterance =  '"______ of the ' + stim.object +
                      ' ' + stim.effect + '."';
      ...
      var N = stim.N;
//      $("#none").html("none");
//      $("#other").html("<span style='font-weight:italic'>other</span>");
//      $("#some").html("some");
//      $("#all").html("all");
      $("#cause").html(cause);
...
//      this.stim.actual_effect_question = effect_question;
      this.stim.trial_objnumber = trial_objnumber; 
    },
    button : function() {
      var ok_to_go_on = true;
//      var slider_ids = ["none", "some", "all", "other"];
...
//        }
      ...
      if (ok_to_go_on) {
	    this.stim.actual_utterance = $("#eventdescription").val();         	
        this.log_responses();
        $(".err").hide();
...
//        var slider_id = slider_ids[i];
        exp.data_trials.push({
          ...
          "num_objects_affected": this.stim.trial_objnumber,
