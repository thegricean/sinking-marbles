function make_slides(f) {
  ...
  slides.cause_effect_prior = slide({
	...
	$("#eventdescription").val("");    	
      ...
      var effect_question = "Why do you think " + stim.other_name + " described the event that way?";
      var utterance = '';
...
//        }
      ...
      if (ok_to_go_on) {
	    this.stim.eventdescription = $("#eventdescription").val();         	
        this.log_responses();
        $(".err").hide();
    ...
    log_responses : function() {
        exp.data_trials.push({
	      ...
	      "explanation" : this.stim.eventdescription,
