function make_slides(f) {
  ...
  slides.cause_effect_prior = slide({
    ...
    present_handle : function(stim) {
      ...
      var N = stim.N;
      $("#0").html("0"  + " " + stim.object + " " + stim.effect);
      $("#1").html("1"  + " " + stim.object_sg + " " + stim.effect);      
      $("#2").html("2"  + " " + stim.object + " " + stim.effect);
      $("#3").html("3"  + " " + stim.object + " " + stim.effect);      
      $("#4").html("4"  + " " + stim.object + " " + stim.effect);
      $("#5").html("5"  + " " + stim.object + " " + stim.effect);      
      $("#6").html("6"  + " " + stim.object + " " + stim.effect);
      $("#7").html("7"  + " " + stim.object + " " + stim.effect);      
      $("#8").html("8"  + " " + stim.object + " " + stim.effect);
      $("#9").html("9"  + " " + stim.object + " " + stim.effect);      
      $("#10").html("10"  + " " + stim.object + " " + stim.effect);
      $("#11").html("11"  + " " + stim.object + " " + stim.effect);      
      $("#12").html("12"  + " " + stim.object + " " + stim.effect);
      $("#13").html("13"  + " " + stim.object + " " + stim.effect);      
      $("#14").html("14"  + " " + stim.object + " " + stim.effect);
      $("#15").html("15"  + " " + stim.object + " " + stim.effect);      
