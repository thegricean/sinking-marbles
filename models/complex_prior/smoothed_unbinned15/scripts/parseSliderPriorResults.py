...
headers = ["Item","QUD","State","Alternatives","SpeakerOptimality","Prior","PosteriorProbability"]        
k = 0
mcnt = 0
condcnt = 0
priorcnt = 0
...
#			print priorcnt
#			print len(items)
			results.append([item,qud, ssize[j], alts, spopt, prior, prob[j]])
		k = k + 1
		priorcnt = priorcnt + 1		
...
oname = '../results/data/parsed_priorslider_results.tsv'
