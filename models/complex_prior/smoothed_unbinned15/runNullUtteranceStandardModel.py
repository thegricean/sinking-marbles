...
f = open("nullutterance_standard_model.church")
...
rfile = open("results/nullutterance_results.txt","w")	
#results = []
...
#		print "".join(open("results_simulation/raw/test.txt").readlines())
    rfile.write("".join(open("results/raw_nullutterance_results.txt").readlines()))
