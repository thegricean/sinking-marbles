...
## Inferred wonkinessPrior using uniform backoff

```{r}
load("~/Documents/research/sinking-marbles/results/wrsa_1stpass_wp_mcmc0.5kb0.25k_x2.Rdata")
qplot(bda.results$`alpha,NA`)
...
## Fixed wonkinessPrior using binomial(0.5) backoff
