...
fname = '../results/model_results/wonky_results.txt'
file_names = [fname]
...
headers = ["Item","QUD","Wonky","Alternatives","SpeakerOptimality","PosteriorProbability","SmoothingBW"]        
k = 0
mcnt = 0
condcnt = 0
priorcnt = 0
...
#			print priorcnt
#			print len(items)
			results.append([items[priorcnt],qud, ssize[j], alts, spopt, prob[j],smoothing_bw])
		k = k + 1
...
oname = '../results/data/parsed_wonky_results.tsv'
