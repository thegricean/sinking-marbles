...
function readPriors(priorfileName){

  // e.g., "priors_numbertask_smoothed.csv", "priors_numbertask4step_smoothed.csv"
...
//  var priorfile = dfilepath+ 'priors_original.csv'
  var priorfile = dfilepath + priorfileName// 
  ...
  var priorClean = _.fromPairs(_.map(dPriors.slice(1),function(x){
...
function readData(dataFile){
  // 'empirical_binarywonky.csv'
  // var dfilepath = "../writing/_2015/_journal_cognition/data/";
  // var dfilepath = "./";
  var dfilepath = 'data/';
  // wonky truth judgement data
 var priorfile = dfilepath+ dataFile;
 // var priorfile = dfilepath+ 'empirical_binarywonky_nozero.csv'
  ...
  var empiricalClean = _.fromPairs(_.map(itemNames,
                            function(i){return [i, 
                              _.fromPairs(_.map(quantifiers,
                                function(q){return [q,
                                _.fromPairs(_.map(dependentMeasures,
