...
f = open("wonkyworld-uniform-untruthful.church")
...
rfile = open("modelresults/results_uniform_untruthful.txt.tmp.results","w")
...
for k,p in enumerate(priors_15):
	...
	for ww in wpriors:
		...
		rfile.write("".join(open("modelresults/raw_uniform_untruthful_results.txt.tmp.results").readlines()))
