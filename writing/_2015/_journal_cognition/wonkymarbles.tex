...
To this end, we introduce two unreliable speakers: a speaker who has an incentive to be misleading in a courtroom scenario and a drunken speaker. \ndg{at some point cite bonnefon's work on drunken SI?}\jd{i can't find the reference, maybe it's not published? i wrote to him.} These speakers are contrasted within participants with a reliable speaker.
