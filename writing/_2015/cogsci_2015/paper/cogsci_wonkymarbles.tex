...
\red{WONKY RSA MODEL; BRIDGE TO EXPERIMENT: SO WE SEE THAT WRSA DOES BETTER AT CAPTURING THE COMPREHENSION DATA, BUT IS THIS REALLY BECAUSE LISTENERS ARE INFERRING WONKINESS? TEST IN EXP. 3}

\red{from previous start to model section: 
...
See \figref{fig:wonkymodel} for predicted wonkiness probabilities for \emph{all}, \emph{none}, and \emph{some}. \red{this is still the uniform model prediction}
